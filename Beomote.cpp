...
void Beomote::initialize(int pin)
{
  ...
  //TCCR1A : COM1A1 COM1A0 COM1B1 COM1B0 xxxx  xxxx WGM11 WGM10
  //TCCR1B : ICNC1  ICES1  xxxx   WGM13  WGM12 CS12 CS11  CS10
  //bit    :   7      6     5       4      3     2    1    0
  ...
  //F_CPU 20 MHz, TICK 625
  long cycles = (F_CPU / 2000000) * TICK;
  ICR1 = cycles;
  //6250

  //TCCR1B &= ~(_BV(CS10) | _BV(CS11) | _BV(CS12));
  //TIMSK1 : xxx xxx ICIE1 xxx xxx OCIE1B OCIE1A TOIE1 
  //Setting the timer overflow interrupt enable bit
  TIMSK1 = _BV(TOIE1);

  //start clock (no prescaling, clk_I/O / 1)
  TCCR1B |= _BV(CS10);
}
